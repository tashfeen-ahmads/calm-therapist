...
export const POSTS: BlogPost[] = [
  {
    ...
    description:
      "Most AI therapy products have no memory. Each session begins from zero. We unpack why that broken architecture exists, the human cost of repeating yourself, and how Calm AI solves it.",
    ...
    internalLinks: [
      ...
      { href: "/how-it-works", label: "How Calm AI works" },
    ...
    body: [
      ...
      "Calm AI was built around this gap. The architecture is memory-first. Every session feeds a structured profile of the person you are: your relationships, your work, your values, your patterns, your goals. When you come back two weeks later, Calm AI already knows. It will say your sister's name. It will remember that Tuesday is your hardest day. It will follow up on the thing you said in passing.",
  ...
  },
  {
    ...
    description:
      "Men access mental health support at significantly lower rates than women. The gap isn't apathy — it's interface. We explore why, and how Calm AI's tone system was built to bridge it.",
    ...
    body: [
      ...
      "There's a deeper point here. The framing of \"men should be able to talk about feelings\" puts the burden on men to change. Calm AI takes a different position: the tools should change. If the tool meets you where you are — in tone, in modality, in time of day — then talking happens. We have seen it happen. Men who would have laughed at \"therapy\" use Calm AI daily.",
  ...
  },
  {
    ...
    description:
      "Most AI therapy products treat your conversations as training data. We pull back the curtain on the privacy landscape and explain Calm AI's commitments — in plain language.",
    ...
    body: [
      ...
      "Calm AI was built around a different premise. We do not train on your conversations. We do not sell your data. We do not share it with third parties. These are not aspirational claims — they are architectural commitments, baked into the system. Sessions are encrypted. Memory is per-user and isolated. You can export everything you've ever said in one click. You can delete everything in one click. None of that is opt-in.",
