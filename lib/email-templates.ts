  ...
  <tr><td align="center">
    <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;background:#FAFAF8;">
      <tr><td style="padding:0 0 24px 0;">
        <span style="font-family:Georgia,'Times New Roman',serif;font-size:22px;font-weight:500;color:#2D2D2D;">Calm AI Therapy</span>
      </td></tr>
      ...
      <tr><td style="padding:24px 8px;font-size:12px;color:#7C7C7C;line-height:1.6;">
        You're getting this because you opened a space at Calm AI Therapy. We don't sell your data. Reply if you want to talk to a real person.
      </td></tr>
    </table>
  </td></tr>
</table>
...
— Calm AI Therapy`,
      html: wrap(
        ...
        `<p style="font-size:16px;line-height:1.7;margin:0 0 12px;">${name},</p>
         ...
         <p style="font-size:14px;color:#5C5C5C;margin:18px 0 0;">— Calm AI Therapy</p>`
      ),
    }),
  },
  ...
  "verify-email": {
    ...
    build: ({ name, actionUrl }) => ({
      subject: "Confirm your email — Calm AI Therapy",
      text: `${name},
...
— Calm AI Therapy`,
  ...
  "password-reset": {
    ...
    delayMinutes: 0,
    build: ({ name, actionUrl }) => ({
      subject: "Reset your Calm AI Therapy password",
      text: `${name},
