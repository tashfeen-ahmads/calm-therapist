      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            role="dialog"
            aria-label="Start a free Calm AI Therapy session"
          >
            <button
              type="button"
            ...
            {!submitted ? (
              <>
                ...
                <p style={{ fontSize: 14, color: "var(--calm-ink-70)", lineHeight: 1.6, marginBottom: 16 }}>
                  Drop your email and Calm AI Therapy will hold your spot. Your first conversation
                  is one minute away.
                </p>
              ...
              <>
                ...
                <p style={{ fontSize: 14, color: "var(--calm-ink-70)", lineHeight: 1.6, marginBottom: 16 }}>
                  Continue to your account — onboarding takes about 3 minutes and Calm AI Therapy
...
function headlineForPath(pathname: string | null): string {
  ...
  if (pathname.startsWith("/for/anxiety")) return "Anxiety doesn't wait. Neither does Calm AI Therapy.";
