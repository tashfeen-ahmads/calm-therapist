...
export const metadata = pageMetadata({
  title: "AI Therapist for Anxiety | Free, Remembers You | Calm AI Therapy",
  description:
...
export default function AnxietyPage() {
  return (
    <ConditionPageTemplate
      ...
      ctFeatures={[
        { title: "Voice-first when needed", body: "When typing is impossible, you can speak. Calm AI Therapy's voice agent is built for anxious moments — short responses, slow pacing, no rush.", href: "/features/voice" },
        { title: "Memory that holds", body: "Anxious people repeat themselves because they have to. Calm AI Therapy remembers — your job, your relationships, your triggers — so you don't.", href: "/features/chat" },
      ...
      faqs={[
        { q: "Is Calm AI Therapy a replacement for an anxiety therapist?", a: "No. Calm AI Therapy is a companion that helps you between sessions — or for moments where therapy isn't accessible. If you have a clinician, the longitudinal record is something you can share with them." },
        { q: "Does it help during a panic attack?", a: "Calm AI Therapy's voice mode is built for high-anxiety moments. It speaks slowly, uses grounding techniques, and never adds to your cognitive load. Crisis Safe activates automatically if your language indicates immediate danger." },
        ...
        { q: "Will it remember my triggers?", a: "Yes. Memory is built into every mode. The longer you use Calm AI Therapy, the more accurately it understands your specific anxiety pattern." },
        { q: "Is my data safe?", a: "Calm AI Therapy does not train on your conversations. Your record is stored for you, in your account, and you can delete everything at any time." },
      ]}
      related={[
