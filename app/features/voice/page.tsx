...
export const metadata = pageMetadata({
  title: "Voice AI Therapist | Talk When Typing Is Too Much | Calm AI Therapy",
  description:
    "Voice-based AI therapy that listens, reflects, and remembers. Calm AI Therapy's voice agent is built for the moments you can't type — anxiety, exhaustion, grief, or just walking.",
  path: "/features/voice",
});
...
export default function VoiceModePage() {
  return (
    <FeaturePageTemplate
      ...
      steps={[
        { title: "Press to start", body: "Calm AI Therapy opens with your name and a soft question. No menus." },
      ...
      who={[
        ...
        { title: "When you're crying", body: "Typing through tears is impossible. Speaking is sometimes easier. Calm AI Therapy holds that." },
