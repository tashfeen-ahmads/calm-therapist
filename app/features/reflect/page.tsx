...
export const metadata = pageMetadata({
  title: "Monthly Reflect | Real Progress, Not Performance | Calm AI Therapy",
  description:
    "Monthly Reflect by Calm AI Therapy gives you a real summary of your inner life across the month. See your shift, your themes, and your own quotes back to you.",
...
export default function ReflectModePage() {
  return (
    <FeaturePageTemplate
      ...
      steps={[
        { title: "End of month trigger", body: "Calm AI Therapy generates the reflection without you asking." },
        { title: "Three sections", body: "What came up most. Where you shifted. Quotes you said about yourself." },
        { title: "Set focus for next month", body: "One sentence. Calm AI Therapy orients itself around it." },
      ]}
      who={[
      ...
      body={[
        "Monthly Reflect is the slowest, most patient mode in Calm AI Therapy. It is the mode you don't need every week, but the one that, looking back, you'll be glad existed. It compresses 30 days of voice, chat, and journal data into a coherent retrospective — not as a dashboard, but as a piece of writing.",
        ...
        "There is no scoring. There are no points. There is no streak. Calm AI Therapy refuses gamification because gamification destroys the work. The reflect is contemplative by design.",
        "At the end of the reflect, Calm AI Therapy asks you for one sentence: a focus for next month. That sentence becomes the lens for the month ahead. Calm AI Therapy references it in chat, in voice, in your weekly journal. The reflect is the only mode where Calm AI Therapy proactively reaches out to you — once a month, when you're ready.",
      ]}
    />
  );
}
