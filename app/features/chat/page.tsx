...
export const metadata = pageMetadata({
  title: "Chat Agent AI Therapy | Calm AI Therapy — Write Your Way Back",
  description:
    "Chat-based AI therapy that builds on every message. The Calm AI Therapy chat agent is structured, private, and builds a longitudinal record of your inner life.",
  path: "/features/chat",
});
  ...
  return (
    <FeaturePageTemplate
      ...
      steps={[
        ...
        { title: "Type at your own pace", body: "Calm AI Therapy doesn't rush you. There's no \"thinking\" indicator. No artificial pressure." },
      ...
      who={[
        ...
        { title: "When it's late", body: "3am, can't sleep. Calm AI Therapy is available. No appointment, no waiting." },
      ...
      body={[
        "The chat agent is Calm AI Therapy's most-used mode for a reason: it asks nothing of you. You can open it, type one sentence, and close it. The next time you open it, that sentence is still there — and Calm AI Therapy remembers what you wrote.",
        ...
        "What it never does: it never produces canned affirmations, it never forgets you exist, it never tells you how to feel, and it never closes the conversation with a dead-end statement. Every response from Calm AI Therapy either reflects something specific back to you or asks one honest question.",
      ]}
    />
  );
}
